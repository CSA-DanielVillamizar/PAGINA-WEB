/**
 * Módulo de datos geográficos completos de Colombia.
 * Contiene departamentos y municipios principales según división político-administrativa.
 * Arquitectura: Datos estáticos separados de lógica (Clean Architecture).
 */
...
export const departamentosColombia: DepartamentoColombia[] = [
  ...
  { 
    nombre: 'Nariño', 
    ciudades: ['Pasto', 'Albán', 'Aldana', 'Ancuyá', 'Arboleda', 'Barbacoas', 'Belén', 'Buesaco', 'Chachagüí', 'Colón', 'Consacá', 'Contadero', 'Córdoba', 'Cuaspud', 'Cumbal', 'Cumbitara', 'El Charco', 'El Peñol', 'El Rosario', 'El Tablón de Gómez', 'El Tambo', 'Francisco Pizarro', 'Funes', 'Guachucal', 'Guaitarilla', 'Gualmatán', 'Iles', 'Imués', 'Ipiales', 'La Cruz', 'La Florida', 'La Llanada', 'La Tola', 'La Unión', 'Leiva', 'Linares', 'Los Andes', 'Magüí', 'Mallama', 'Mosquera', 'Nariño', 'Olaya Herrera', 'Ospina', 'Policarpa', 'Potosí', 'Providencia', 'Puerres', 'Pupiales', 'Ricaurte', 'Roberto Payán', 'Samaniego', 'San Andrés de Tumaco', 'San Bernardo', 'San Lorenzo', 'San Pablo', 'San Pedro de Cartago', 'Sandoná', 'Santa Bárbara', 'Santacruz', 'Sapuyes', 'Taminango', 'Tangua', 'Túquerres', 'Yacuanquer'] 
  },
  { 
  ...
  { 
    nombre: 'Sucre', 
    ciudades: ['Sincelejo', 'Buenavista', 'Caimito', 'Chalán', 'Coloso', 'Corozal', 'Coveñas', 'El Roble', 'Galeras', 'Guaranda', 'La Unión', 'Los Palmitos', 'Majagual', 'Morroa', 'Ovejas', 'Palmito', 'Sampués', 'San Benito Abad', 'San Juan de Betulia', 'San Marcos', 'San Onofre', 'San Pedro', 'Sincé', 'Sucre', 'Tolú', 'Tolú Viejo'] 
  },
  { 
    nombre: 'Tolima', 
  ...
  { 
    nombre: 'Vaupés', 
    ciudades: ['Mitú', 'Caruru', 'Pacoa', 'Papunaua', 'Taraira', 'Yavaraté'] 
  },
  { 
    nombre: 'Vichada', 
...
/**
 * Función auxiliar para obtener ciudades dado el nombre del departamento.
 * Facilita selects dependientes en formularios (Clean Architecture: utilitarios reutilizables).
 */
export function obtenerCiudades(departamento: string): string[] {
  return departamentosColombia.find(d => d.nombre === departamento)?.ciudades || [];
}
